...
> **Note:** This review was generated by an AI model (\`${OPENAI_MODEL}\`) from
> the PR diff. The diff content may have influenced the output. Do not treat
> this as a trusted security assessment.
